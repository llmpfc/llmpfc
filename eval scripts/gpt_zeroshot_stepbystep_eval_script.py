...
for file in os.listdir(args.output_dir):
	...
	for i in range(env_feedback_index):


		if 'Move' in lines_baseline[i] and 'from list' in lines_baseline[i] and 'to list' in lines_baseline[i] and (('A' in lines_baseline[i] and 'B' in lines_baseline[i] ) or ('C' in lines_baseline[i] and 'B' in lines_baseline[i] ) or ('A' in lines_baseline[i] and 'C' in lines_baseline[i] )):
