	...
	for count in range(2):
		...
		for step in range(20):
			...
			if current_room == final_target_room:
				flag=1
				total_reward+=10
				with open('/jukebox/griffiths/people/smondal/cogeval/logs/gpt4 zeroshot steppath step by step external feedback/problem{}_{}_optimal_steps_{}_reward_{}.log'.format(start_room,final_target_room,optimal_num_steps,optimal_reward), 'a') as w:
