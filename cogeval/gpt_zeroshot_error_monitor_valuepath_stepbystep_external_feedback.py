	...
	if start_room!=8 and start_room!=15:
		...
		for step in range(20):
			...
			if current_room in reward_rooms:
				...
				with open('/jukebox/griffiths/people/smondal/cogeval/logs/gpt4 zeroshot with error monitor valuepath step by step external feedback/problem{}.log'.format(start_room), 'a') as w:
