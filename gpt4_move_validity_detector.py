...
for i in range(78,len(all_As)):
	...
	for idx,msg in enumerate(move_messages):
		...
		with open('/jukebox/griffiths/people/smondal/tower of hanoi/logs/gpt4 move validity detector more detailed instructions two shot/problem{}_move{}.log'.format(i+1,idx+1), 'a') as w:
			w.write(prompt +'\n')
