...
def generate_all_start_config():
	...
	# print("Total number of examples>>",len(all_As),len(all_Bs),len(all_Cs))
	# random_sampled_indices = random.sample(list(np.arange(len(all_As))),20)
	# print("Few randomly chosen examples >>")
	# for ind in random_sampled_indices:
		# print('A={}, B={}, C={}'.format(all_As[ind],all_Bs[ind],all_Cs[ind]))
	return all_As, all_Bs, all_Cs
	


# generate_all_start_config()
