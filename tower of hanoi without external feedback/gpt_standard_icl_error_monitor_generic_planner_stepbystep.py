...
def state_evaluator_module(state_A,state_B,state_C,goal_config,num_input_tokens,num_output_tokens):
...
for i in range(26):
	if (i+1) not in icl_examples:
		...
		""".format(standard_prompt,"A = "+str(A),"B = "+str(B),"C = "+str(C),"A = "+str(goal_configuration[0]),"B = "+str(goal_configuration[1]),"C = "+str(goal_configuration[2]))
		...
		for step in range(30):
			...
			move_proposals, max_content_limit_exceed_count,num_input_tokens,num_output_tokens = actor_module_propose_two_actions(input,first_temp_current_configuration,goal_configuration,step,max_content_limit_exceed_count,num_input_tokens,num_output_tokens)
			...
			if (next_temp_current_configuration1 == goal_configuration) or (next_temp_current_configuration2 == goal_configuration):

				moves_from_next_temp_current_configuration1,num_input_tokens,num_output_tokens = state_evaluator_module(next_temp_current_configuration1[0],next_temp_current_configuration1[1],next_temp_current_configuration1[2],goal_configuration,num_input_tokens,num_output_tokens)
				moves_from_next_temp_current_configuration2,num_input_tokens,num_output_tokens = state_evaluator_module(next_temp_current_configuration2[0],next_temp_current_configuration2[1],next_temp_current_configuration2[2],goal_configuration,num_input_tokens,num_output_tokens)
				...
				""" .format("A = "+str(next_temp_current_configuration1[0]),"B = "+str(next_temp_current_configuration1[1]),"C = "+str(next_temp_current_configuration1[2]), "A = "+str(goal_configuration[0]),"B = "+str(goal_configuration[1]),"C = "+str(goal_configuration[2]))
		

				prompt_state1= root_prompt+ "\n"+move_proposals[0]+ "." +"\n"+internal_configuration_msg
				...
				next_move_proposals1, max_content_limit_exceed_count,num_input_tokens,num_output_tokens = actor_module_propose_two_actions(input,next_temp_current_configuration1,goal_configuration,step,max_content_limit_exceed_count,num_input_tokens,num_output_tokens)
				...
				""" .format("A = "+str(next_temp_current_configuration2[0]),"B = "+str(next_temp_current_configuration2[1]),"C = "+str(next_temp_current_configuration2[2]), "A = "+str(goal_configuration[0]),"B = "+str(goal_configuration[1]),"C = "+str(goal_configuration[2]))
		

				prompt_state2= root_prompt+ "\n"+move_proposals[1]+ "." +"\n"+internal_configuration_msg
				...
				next_move_proposals2, max_content_limit_exceed_count,num_input_tokens,num_output_tokens = actor_module_propose_two_actions(input,next_temp_current_configuration2,goal_configuration,step,max_content_limit_exceed_count,num_input_tokens,num_output_tokens)
				
				print("move proposals from config 2>>",next_move_proposals2)

				# print("input now>>>",input)

				next_next_temp_current_configuration1_1,num_input_tokens,num_output_tokens = state_predictor_module(next_temp_current_configuration1[0], next_temp_current_configuration1[1], next_temp_current_configuration1[2] ,next_move_proposals1[0],num_input_tokens,num_output_tokens)
				
				next_next_temp_current_configuration1_2,num_input_tokens,num_output_tokens = state_predictor_module(next_temp_current_configuration1[0], next_temp_current_configuration1[1], next_temp_current_configuration1[2] ,next_move_proposals1[1],num_input_tokens,num_output_tokens)
				...
				next_next_temp_current_configuration2_1,num_input_tokens,num_output_tokens = state_predictor_module(next_temp_current_configuration2[0], next_temp_current_configuration2[1], next_temp_current_configuration2[2] ,next_move_proposals2[0],num_input_tokens,num_output_tokens)
				
				next_next_temp_current_configuration2_2,num_input_tokens,num_output_tokens = state_predictor_module(next_temp_current_configuration2[0], next_temp_current_configuration2[1], next_temp_current_configuration2[2] ,next_move_proposals2[1],num_input_tokens,num_output_tokens)
				...
				moves_from_next_next_temp_current_configuration1_1,num_input_tokens,num_output_tokens = state_evaluator_module(next_next_temp_current_configuration1_1[0],next_next_temp_current_configuration1_1[1],next_next_temp_current_configuration1_1[2],goal_configuration,num_input_tokens,num_output_tokens)
				moves_from_next_next_temp_current_configuration1_2,num_input_tokens,num_output_tokens = state_evaluator_module(next_next_temp_current_configuration1_2[0],next_next_temp_current_configuration1_2[1],next_next_temp_current_configuration1_2[2],goal_configuration,num_input_tokens,num_output_tokens)
				
				moves_from_next_next_temp_current_configuration2_1,num_input_tokens,num_output_tokens = state_evaluator_module(next_next_temp_current_configuration2_1[0],next_next_temp_current_configuration2_1[1],next_next_temp_current_configuration2_1[2],goal_configuration,num_input_tokens,num_output_tokens)
				moves_from_next_next_temp_current_configuration2_2,num_input_tokens,num_output_tokens = state_evaluator_module(next_next_temp_current_configuration2_2[0],next_next_temp_current_configuration2_2[1],next_next_temp_current_configuration2_2[2],goal_configuration,num_input_tokens,num_output_tokens)
			...
			""".format("A = "+str(next_state_prediction[0]),"B = "+str(next_state_prediction[1]),"C = "+str(next_state_prediction[2]),"A = "+str(goal_configuration[0]),"B = "+str(goal_configuration[1]),"C = "+str(goal_configuration[2]))
			...
			""".format("A = "+str(current_configuration[0]),"B = "+str(current_configuration[1]),"C = "+str(current_configuration[2]),"A = "+str(goal_configuration[0]),"B = "+str(goal_configuration[1]),"C = "+str(goal_configuration[2]))
			...
			if next_state_prediction == goal_configuration:
				flag=1
		...
		if flag==0:
			...
			with open(output_dir+'problem{}.log'.format(i+1), 'a') as w:
				w.write(root_prompt +'\n'+"Timed out. Couldn't solve problem in 30 steps. Total reward = {}".format(total_reward))
