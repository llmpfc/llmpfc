...
for i in range(106):
	...
	# })
		...
		if current_configuration == target_configuration:
			flag=1
			total_reward+=100
			with open('/jukebox/griffiths/people/smondal/tower of hanoi/logs/gpt4 standard icl reward structure given step by step external feedback/problem{}.log'.format(i+1), 'a') as w:
