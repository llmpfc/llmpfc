...
for i in range(106):
	...
	for step in range(50):
		...
		if current_configuration == target_configuration:
			flag=1
			total_reward+=100
			with open('/jukebox/griffiths/people/smondal/tower of hanoi/logs/gpt4 standard icl with error monitor, planner, try propose two moves with temperature step by step external feedback/problem{}.log'.format(i+1), 'a') as w:
